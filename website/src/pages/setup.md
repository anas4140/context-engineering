---
title: Setup Guide
description: Step-by-step instructions to install dependencies, get an API key, and run your first lesson.
---

# Getting Started — Step-by-Step Setup Guide

Follow every step in order. The whole process takes about 5 minutes.
...
:::note
`sentence-transformers` downloads a ~90 MB model file on first use — that's normal. It caches locally after the first download.
:::
...
:::tip Free tier
New accounts get **$5 of free credits** — enough to run every lesson in this course.
:::
...
:::warning
The `.env` file is in `.gitignore` — it will never be committed to git. Never share your API key publicly.
:::
...
See the **[Troubleshooting Guide](/context-engineering/troubleshooting)** for solutions to the most common errors.
